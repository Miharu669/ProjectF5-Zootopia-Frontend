...
const inactiveClass = ref(
  'text-white hover:bg-random-100 hover:text-random-50 hover:rounded-l-full',
)
</script>
    ...
    <div :class="isOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
      ...
      <nav class="mt-10">
        <router-link class="flex items-center px-6 py-4 mt-4 duration-200 border-l-4"
          ...
          <svg :class="route.name === 'Dashboard' ? 'text-random-50' : 'text-white'" class="w-5 h-5 fill-current"
        ...
        <router-link class="flex items-center px-6 py-4 mt-4 duration-200 border-l-4"
          ...
          <svg :class="route.name === 'Forms' ? 'text-random-50' : 'text-white'" class="w-5 h-5 fill-current"
